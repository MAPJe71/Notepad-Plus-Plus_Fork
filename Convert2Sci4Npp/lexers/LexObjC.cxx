...
static void ColouriseObjCDoc( unsigned int  startPos
                            , int           length
                            , int           initStyle
                            ...
                            )
{
    ...
    WordList &mainInstrsList    = *keywordlists[0]; // Common Instruction
    WordList &mainTypesList     = *keywordlists[1]; // Common Type
...
static bool matchKeyword( unsigned int start
                        , WordList &keywords
                        , Accessor &styler
                        , int keywordtype
                        )
...
static void FoldObjCDoc( unsigned int  startPos
                       , int           length
                       , int           initStyle
                       , WordList *    keywordlists[]
                       , Accessor &    styler
...
static void ColouriseObjCDocSensitive( unsigned int  startPos
                                     , int           length
                                     , int           initStyle
                                     , WordList *    keywordlists[]
                                     , Accessor &    styler
